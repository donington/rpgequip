...
public class DoomScepter extends Item {
	private static final String unlocalizedName = "doom_scepter";
...
//    	System.out.println("spawning fire");
    	world.spawnEntityInWorld(new EntityMagicFire(world, (EntityLivingBase)player));
    	return stack;
	}
